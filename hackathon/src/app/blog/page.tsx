...
function Blog() {
    return (
        <div className="max-w-screen-2xl container mx-auto pb-8 px-4 h-96 w-full">
          <Header />
            {/* Header Section */}
            ...
            <Image
  src="https://images.ctfassets.net/5de70he6op10/4DC2ql5VklfVT6s8VWQOUO/52be236e7a5e825074abf649d07c9eb2/655582921-furniture_gateway_ss_07.jpg" // Replace with a valid image URL or property
  alt="Default Product" // Dynamic alt text for the product
  height={400}
  width={600}
  className="w-full h-[200px] md:h-auto object-cover"
/>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <h1 className="text-black md:text-5xl font-bold">Blog</h1>
                    <div className="mt-4 text-black text-xs md:text-xl flex items-center">
